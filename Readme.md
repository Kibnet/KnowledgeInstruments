...
## zenkuro
### Работа с информацией
pdf, plain text, docear
### Боль
pdf, plain text -> очевидно

docear -> всего 1 плоскость, хочется большей глубины и больше связей, тяжело делиться информацией
### Как решаю
стродаю
### Как хотелось бы решать
Нужно видение многоуровневой платформы для работы с даным,
протокола или стека/иерархии протоколов вроде модели OSI для которого другие люди могли бы начать накручивать свои
подпротоколы, тулы, фреймворки
